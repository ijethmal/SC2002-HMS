...
public class MedicineModel {
    ...
    protected void setMedicineName(String medicineName) {
        this.medicineName = medicineName;
    }
    ...
    protected double getLowStockAlertLine() {
        return lowStockAlertLine;
    }

    protected void setLowStockAlertLine(double lowStockAlertLine) {
        this.lowStockAlertLine = lowStockAlertLine;
    }

    protected void setStockLevel(double stockLevel) {
        this.stockLevel = stockLevel;
    }
}